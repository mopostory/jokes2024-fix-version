...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        visit_our_website_button = QtWidgets.QPushButton("Visit our website", self)
        visit_our_website_button.move(100, 60)
        visit_our_website_button.clicked.connect(self.close)
